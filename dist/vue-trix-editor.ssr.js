'use strict';Object.defineProperty(exports,'__esModule',{value:true});var Trix=require('trix');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var Trix__default=/*#__PURE__*/_interopDefaultLegacy(Trix);//
var script = {
  name: 'VueTrixEditor',
  model: {
  ...
  mounted: function mounted() {
    Trix__default['default'].config.attachments.preview.caption = {
      name: false,
      size: false
    };
  ...
  methods: {
    hideToolbarAttachBtn: function hideToolbarAttachBtn() {
    ...
    init: function init() {
      ...
      this.$refs.trix.addEventListener('trix-change', function () {
        _this.$emit('input', _this.content());
      });
      this.$emit('initialized');
    },
    content: function content() {
      return document.querySelector("#".concat(this.uniqueId)).value;
    },
    checkFile: function checkFile(ev) {
      if (!this.imageUploads) {
        return ev.preventDefault();
      }
    },
    acceptFile: function acceptFile(ev) {
      // eslint-disable-next-line no-prototype-builtins
      if (ev.hasOwnProperty('attachment') && ev.attachment.file) {
        this.$emit('trix-attachment-add', ev.attachment);
      }
    },
    removeFile: function removeFile(ev) {
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', [_vm._ssrNode((_vm.label ? "<label" + _vm._ssrClass(null, "trix-label " + (_vm.focused ? 'trix-label--focused' : '')) + ">" + _vm._ssrEscape("\n    " + _vm._s(_vm.label) + "\n  ") + "</label>" : "<!---->") + " "), _c('trix-editor', {
    ref: "trix",
    ...
    on: {
      ...
      "trix-focus": function trixFocus($event) {
        _vm.focused = true;
      },
      "trix-blur": function trixBlur($event) {
        _vm.focused = false;
      }
    }
  }), _vm._ssrNode(" <input" + _vm._ssrAttr("id", _vm.uniqueId) + " type=\"hidden\" name=\"content\">")], 2);
};
...
var __vue_module_identifier__ = "data-v-36520e6c";
/* functional template */
...
var install = function installVueTrixEditor(Vue) {
